...
class ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    Fluttertoast.showToast(msg: 'Messages will be deleted after 20 seconds');
  ...
  deletingMessages(int index, DocumentSnapshot data) {
    if (data['seen'] == 1) {
  ...
  messageSeen(int index, DocumentSnapshot data) {
    if (data['idTo'] == User.userData.id) {
      Firestore.instance
          .collection('messages')
          .document(groupChatId)
          .collection(groupChatId)
  ...
  Widget buildItem(int index, DocumentSnapshot document) {
    if (document['seen'] == 0) {
      messageSeen(index, document);
    }
    deletingMessages(index, document);
